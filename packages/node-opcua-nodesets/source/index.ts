...
export type NodesetMeta = {
    ...
    xmlFile: string;
    /// set to true if no package should be generated for this nodeset
    /// (this may be removed in the future -- was added to avoid changing behavior during refactoring)
    _shouldExcludeFromBuild: boolean;
};
